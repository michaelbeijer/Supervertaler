...
- Output clean, readable text only (no commentary)"""
    ...
    def _save_session_report(self):
        ...
        try:
            ...
            # Footer
            report_lines.append("---\n\n")
            report_lines.append("<p align='center'>\n")
            report_lines.append("<em>Report generated by <strong>PDF Rescue</strong> - AI-Powered OCR Tool</em><br>\n")
            report_lines.append("<em>Part of <a href='https://supervertaler.com/'><strong>Supervertaler</strong></a> • by Michael Beijer</em>\n")
