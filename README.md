...
**Latest release:** v1.9.347 - Expert-level AI prompt generation with domain-specific templates, anti-hallucination controls, full glossary extraction, and TM style anchors.
