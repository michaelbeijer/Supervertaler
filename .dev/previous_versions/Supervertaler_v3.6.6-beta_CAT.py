"""  
Supervertaler v3.6.7-beta (CAT Editor)
...
class Supervertaler:
    ...
    def __init__(self, root):
        self.root = root
        self.root.title("Supervertaler v3.6.7-beta - AI-Powered CAT Tool")
        ...
        # Status
        self.log("Supervertaler v3.6.7-beta ready. Import a DOCX file to begin.")
    ...
    def create_start_screen(self):
        ...
        tk.Label(center_frame, text="v3.6.7-beta", 
